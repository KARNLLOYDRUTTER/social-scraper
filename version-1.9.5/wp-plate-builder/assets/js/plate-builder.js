...
const textY = strokeOffsetTotal + marginTopPx + charHeightPx / 2;
      const textEl = `<g class="reg-wrap"><text class="reg-text" y="${textY}" dominant-baseline="middle" text-anchor="middle" style="${textStyle}"${filterAttr}>${tspanStr}</text></g>`;
